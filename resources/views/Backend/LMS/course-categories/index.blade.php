...
<a href="{{ route('course-category.create') }}" class="btn btn-success btn-sm me-0 mb-2">Create Course Category</a>
@endsection
@section('css')
        ...
        <tr>
          ...
          <td>
            <form action="{{ route('course-category.destroy',$CourseCategory->id) }}" method="POST">
              <a class="btn btn-info custom-btn btn-sm" href="{{ route('course-category.edit', $CourseCategory->id) }}"><i class="fas fa-edit"></i></a>
              @csrf
              @method('DELETE')
