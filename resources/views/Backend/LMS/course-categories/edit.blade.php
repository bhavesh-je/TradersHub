        ...
        <div class="card-body">
            <form method="POST" action="{{ route('course-category.update', $EditCourseCat->id) }}">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control custom-control @error('c_c_name') danger-box @enderror" id="c_c_name" name="c_c_name" placeholder="Enter category name" value="{{ $EditCourseCat->c_c_name }}" oninput="this.value = this.value.toLowerCase()">
                    @error('c_c_name')
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea id="description" name="description" class="form-control custom-control" rows="3" placeholder="Write description...">{{ $EditCourseCat->description }}</textarea>
                </div>
                <div class="col-md-12 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
