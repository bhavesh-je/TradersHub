        ...
        <div class="card-body">
            <form method="POST" action="{{ route('faq.update', $faq->id) }}">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control custom-control @error('question') danger-box @enderror" placeholder="Enter question" id="question" name="question" value="{{ $faq->question }}">
                    @error('question')
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea id="answer" name="answer" class="form-control custom-control @error('answer') danger-box @enderror" rows="3" placeholder="Write answer ..." >{{ $faq->answer }}</textarea>
                    @error('answer')
                        {{-- <span id="name-error" class="error invalid-feedback">{{ $message }}</span> --}}
                        <span class="error-text" role="alert">{{ $message }}</span>
                    @enderror
