        ...
        <div class="card-body">
            ...
            <input type="hidden" name="post_type" value="post">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control custom-control @error('post_title') danger-box @enderror" placeholder="Enter post title" id="post_title" name="post_title" value="{{ old('post_title') }}">
                    @error('post_title')
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="file" class="file" accept="image/*" name="post_image">
