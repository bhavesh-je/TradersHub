...
class TakeQuiz extends Component {
    ...
    componentDidMount() {
        ...
        // this.setState({ hoursMinSecs: [...this.state.hoursMinSecs,{"hours": h},{"minutes": m},{"minutes": s}] });
        this.setState({ hoursMinSecs: [...this.state.hoursMinSecs,h,m,s] });
        ...
        // console.log("hours : "+typeof(this.state.hours));
        // console.log("minutes : "+typeof(this.state.minutes));
        // console.log("seconds : "+typeof(this.state.seconds));
        // console.log("hoursMinSecs : "+typeof(this.state.hoursMinSecs));
        ...
        return (
            ...
            >
                ...
                <div className='container d-flex justify-content-center pt-4 h3 myclock'>
                    ...
                    {/* <Timer hours={this.state.hours} minutes={this.state.minutes} seconds={60}/> */}
                    <Timer hoursMinSecs={[hours,minutes,seconds]} />
                </div>
